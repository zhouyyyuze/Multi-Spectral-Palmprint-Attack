...
class Solver():
    def __init__(self, model, linear_gcca, outdim_size, epoch_num, batch_size, learning_rate, reg_par,
...
if __name__ == '__main__':
    ...
    layer_sizes3 = [1024, 512, outdim_size]
    ...
    dfs = []
    for o in outputs:
        df = pd.DataFrame(o.cpu(), columns=['x', 'y'])
        df['Classes'] = classes
        dfs.append(df)
